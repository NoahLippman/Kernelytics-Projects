...
kcl_all_files <- list.files(
  path        = "/Users/noahlippman/Documents/GitHub/Kernelytics-Projects/kclData",
  pattern     = "\\.csv$",
  full.names  = TRUE
)

belters_all_files <- list.files(
  path        = "/Users/noahlippman/Documents/GitHub/Kernelytics-Projects/CornBeltersData",
  pattern     = "\\.csv$",
  full.names  = TRUE
)
...
```{r}
savant <- read_csv("savant_data_25.csv")
